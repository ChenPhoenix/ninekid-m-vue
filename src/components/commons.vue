    ...
    <div  :class="[headActive]">
        <header class="header-box">
            ...
            <div class="head-twocode">
                <img @click="erCodeHandle" :src="titleRightImg" alt="二维码">
                <div class="erCodeBox"  :class="{erCodeActive:isErCodeActive }">
                    <img src="http://www.ninekids.net/sites/all/themes/ninekids/ninekids/images/bg-index-4.jpg" alt="童车微信二维码">
                </div>
            </div>
        ...
        methods:{
            ...
            menuHandle(){
                ...
                if(this.isMenuActive){
                    this.isErCodeActive=false
                }
            },
            erCodeHandle(){
                this.isErCodeActive=!this.isErCodeActive;
                if(this.isMenuActive){
